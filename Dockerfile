...
# Runtime stage
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:27db67b8ca93fcc926b7fdccdfbe943e15b4456430fc466913839cad3201e530 AS runtime
