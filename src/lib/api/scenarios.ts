...
export const scenarios = {
  ...
  // Ingen meldekort i det hele tatt (empty state)
  "ingen-meldekort": {
    dagpenger: undefined,
    aap: undefined,
...
export const scenarioMetadata = [
  {
    ...
    items: [
      ...
      {
        name: "kun-dagpenger",
        description: "Kun dagpenger har aktive meldekort → redirect",
      },
      {
        name: "kun-aap",
        description: "Kun AAP har aktive meldekort → redirect",
      },
      {
        name: "kun-tp",
        description: "Kun tiltakspenger har aktive meldekort → redirect",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "alle-ytelser",
        description: "Alle tre ytelser har aktive meldekort",
      },
    ],
  },
  {
    category: "Empty state scenarier",
    items: [
      {
        name: "ingen-meldekort",
        description: "Ingen meldekort i det hele tatt (verken ytelser eller arena)",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "kun-innsendte",
        description:
          'Alle ytelser har kun innsendte meldekort ("Se innsendte")',
      },
      {
        name: "kun-utfylling",
        description:
          'Alle ytelser har kun meldekort til utfylling ("Send inn" / "Fyll ut")',
      },
    ],
  },
] as const;
